      ...
      <div className={styles.cardContainer}>
        ...
        <div className={styles.aboutContainer}>
          ...
          <div className={styles.text}>
            <span>
              Sou um desenvolvedor Front-End cujo interesse é construir sites
              interativos e acessiveis. Minha sessão de projetos contem alguns
              ...
              disposto a melhorar e aprender mais. Entre em contato se estiver
              interessado em me conhecer melhor.
            </span>
          </div>
